...
const terms:Terms[] = [
  ...
  {   
      ...
      subParrafos: ["La aplicación es proporcionada para tu uso personal y no comercial. No puedes utilizar la aplicación con fines ilegales o no autorizados. Al utilizar la aplicación, te comprometes a cumplir con todas las leyes y regulaciones aplicables.",
  ...
  { 
    id:3,
    title: "Privacidad",
    subParrafos:[ "Respetamos tu privacidad y nos comprometemos a proteger la información personal que recopilamos. Nuestra Política de Privacidad describe cómo recopilamos, utilizamos y protegemos tu información personal. Al utilizar la aplicación, aceptas nuestra Política de Privacidad."]
  },
  { 
    id:4,
    title: "Limitación de Responsabilidad",
    subParrafos: ['La aplicación se proporciona "tal cual" y no ofrecemos garantías de ningún tipo, ya sean expresas o implícitas. No garantizamos que la aplicación sea segura, esté libre de errores, virus u otros componentes dañinos, o que funcione de manera ininterrumpida o libre de interrupciones.',
  ...
  { 
    id:5,
    title:"Ley Aplicable",
    subParrafos:["Estos términos y condiciones se regirán e interpretarán de acuerdo con las leyes del país en el que operamos. Cualquier disputa relacionada con la aplicación o estos términos y condiciones estará sujeta a la jurisdicción exclusiva de los tribunales de dicho país."]
  }
